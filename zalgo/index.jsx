  ...
  if (regex.test(message)) {
    ...
    if (message.length > 2000) {
      ...
      showToast({
        ...
        content: "This message would exceed the 2000-character limit.\nReduce corruption amount or shorten text.\n\nLength including corruption: " + value.length,
        onClick() {},
        duration: 3000,
      });
      // e.preventDefault();
...
function doZalgo(match, midMode, ramp, rampEnd, startAmt, endAmt, contents, offset, string) {
  const maxAmt = 10;
  ...
  return getZalgo(contents, corruptMid, parseFloat(rampEnd), parseFloat(startAmt), parseFloat(endAmt));
}
